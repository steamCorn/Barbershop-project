    ...
    <div className="header">
      <div className="headerContainer">
        <div className="headerBar">
          <h1 className="headerTitle">Raise your level instantly</h1>
          ...
          <div className="scrollButtons">
            <button className="leftScroll" onClick={handleLeftArrowClick}>
              left arrow
            </button>
            <button className="rightScroll" onClick={handleRightArrowClick}>
              right arrow
            </button>
          </div>
        </div>
          ...
          <Carousel offset={offset}>
            <div className="sliderItem object-with-pseudo-elem">
              ...
              <button
                ...
                className="play-bt play-bt-style"
              >
                {!videoPlay ? "Play" : "Pause"}
              </button>
            </div>
            <div className="sliderItem">
              <img src={img1} alt="photo_1" />
            </div>
            <div className="sliderItem">
              <img src={img2} alt="photo_2" />
            </div>
            <div className="sliderItem">
              <img src={img3} alt="photo_3" />
            </div>
            <div className="sliderItem">
              <img src={img4} alt="photo_4" />
            </div>
            <div className="sliderItem">
              <img src={img5} alt="photo_5" />
            </div>
          </Carousel>
        </div>
      </div>
